...
```bash
cd "/Users/brockmesarich/Desktop/Claude Code Short System"
python3 .claude/skills/animated-website/scripts/extract_frames.py \
...
```bash
cd "workspace/{today}/animated-sites/{slug}"
